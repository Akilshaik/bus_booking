...
SECRET_KEY = 'django-insecure-zjjb&(&rd^rs^r3t1p6bckc&449f_a*7hosfz&=2z4m0vd3#ou'
...
if db_host not in ("localhost", "127.0.0.1"):
    DB_OPTIONS = {"sslmode": "require"}  # Supabase needs SSL
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {
            "sslmode": "require",  # Supabase uses SSL
        },
    }
}
